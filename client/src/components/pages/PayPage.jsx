      ...
      <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col">
            <form
              action="#"
              className="min-w-[200px] max-w-[575px] rounded-lg border mt-5 mb-5 border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8"
            >
            ...
            <div className="mt-6 grow sm:mt-8 lg:mt-0 min-w-[200px] max-w-[575px]">
